...
VITE_RECAPTCHA_KEY="<your_recaptcha_key_here>"
VITE_CSP="<content_security_policy_string>"
```
...
> **Tips:** Anpassa portarna efter din lokala backend-konfiguration.
...
12. **User Support for GDPR Requests (Artikel 12 & 15)**  
    > Säkerställ att användare kan kontakta support för GDPR‑relaterade ärenden och få svar inom rimlig tid.
...
15. **Consent Logs & Audit Trails (Artikel 30)**  
    > Verifiera att applikationen loggar när och hur samtycken ges, ändras eller återkallas, samt att loggarna är åtkomliga för insyn och uppföljning.
...
Projektet visar hur principer för dataskydd, transparens och användarkontroll kan omsättas i praktiken – genom en modern, säker och tydlig webbaserad applikation.
